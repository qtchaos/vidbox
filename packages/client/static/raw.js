...
function _0x5d62() {
	const _0x32546e = [
		...
		'2771793hUMqEe',
		'2148208JHJeQd',
		'tableIndex\x20out\x20of\x20range\x200-255',
		'5470775rnRVci',
		'encode',
		'toUint32',
		'calculate'
...
(function (_0x1e83e0, _0x33e0c0) {
	...
	while (!![]) {
		try {
			const _0x327e96 =
				-parseInt(_0x15ac4b(0x93)) / 0x1 +
				parseInt(_0x15ac4b(0x9b)) / 0x2 +
				-parseInt(_0x15ac4b(0x9a)) / 0x3 +
				parseInt(_0x15ac4b(0x98)) / 0x4 +
				parseInt(_0x15ac4b(0x9d)) / 0x5 +
				(-parseInt(_0x15ac4b(0x96)) / 0x6) * (-parseInt(_0x15ac4b(0x99)) / 0x7) +
...
class CRC32 {
	...
	[_0x1b9930(0xa0)](_0x516444) {
		...
		for (const _0x2e1c70 of _0x338274) {
			const _0x5e8b93 = (_0x43ea09 ^ _0x2e1c70) & 0xff,
				_0x451b9e = this[_0x46aeee(0x95)]?.[_0x5e8b93];
			if (_0x451b9e === undefined) throw new Error(_0x46aeee(0x9c));
			_0x43ea09 = (_0x43ea09 >>> 0x8) ^ _0x451b9e;
		}
		return this[_0x46aeee(0x9f)](_0x43ea09 ^ 0xffffffff);
	}
	[_0x1b9930(0x94)](_0x37f978) {
		const _0x25ad86 = _0x1b9930,
			_0x5d5447 = new TextEncoder();
		return _0x5d5447[_0x25ad86(0x9e)](_0x37f978);
	}
	[_0x1b9930(0x9f)](_0x5807d0) {
		if (_0x5807d0 >= 0x0) return _0x5807d0;
		const _0x5a2d24 = new Uint32Array(0x1);
		return (_0x5a2d24[0x0] = _0x5807d0), _0x5a2d24[0x0];
	}
}

// Init the CRC32 class
const _0x5a2d24 = new CRC32();
...
// Set the access key so that we can reach it on the embed page
const root = document.querySelector('html');
root.accessKey = await getKey();
